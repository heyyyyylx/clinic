...
import com.example.sparrownotes.util.MsgAdapter;
import com.example.sparrownotes.util.MyDBOpenHelper;
    ...
    public void init() {
        ...
        if(cursor.moveToFirst()) {
            while (cursor.moveToNext()) {
                ...
                @SuppressLint("Range") String xiaoxi = cursor.getString(cursor.getColumnIndex("message"));
